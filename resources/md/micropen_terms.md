...
3) 英国または欧州経済領域（EEA）に属する国に国籍がなく、居住もしていないこと  
...
4) 当該利用者のアカウント凍結処理  
2. モデレーターは、リモートサービスから転送された投稿が第1節の規定に著しく反する場合、以下の処分を行うことができます。当該投稿を行ったリモートユーザーもしくは当該リモートユーザーが所属するリモートサービスの投稿について、本サービスにおける受け入れを中止することができます。  
   1) 本規約に違反している個別の画像ファイルに対する強制的なセンシティブ指定  
   2) 本規約に違反している個別投稿の削除  
   3) 当該利用者の投稿の本サービスにおける受け入れ中止  
   4) 当該利用者の属するリモートサービスに属する全リモートユーザーの投稿の本サービスにおける受け入れ中止  
3. モデレーターは、処分を受けた利用者について、本サービスの運営に支障を来す恐れがないと判断した時点において処分を解除することができます。  
