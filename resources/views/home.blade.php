...
@section('content')
    <section class="my-4 border border-indigo-700 rounded-xl p-4">
        ...
        <nav class="grid grid-cols-4 gap-4">
            <a href="https://mi.kuropen.org/@kuropen" class="col-span-2 border rounded-lg p-2 shadow-lg flex flex-row gap-2 justify-center">
            ...
            <a href="https://bsky.app/profile/kuropen.org" class="col-span-2 border rounded-lg p-2 shadow-lg flex flex-row gap-2 justify-center">
            ...
            <a href="https://x.com/kuropen_aizu" class="border rounded-lg p-2 shadow-lg">
                <div class="w-8 h-8 md:w-12 md:h-12 p-1 mx-auto">
                    <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>X</title><path d="M18.901 1.153h3.68l-8.04 9.19L24 22.846h-7.406l-5.8-7.584-6.638 7.584H.474l8.6-9.83L0 1.154h7.594l5.243 6.932ZM17.61 20.644h2.039L6.486 3.24H4.298Z"/></svg>
                </div>
                <div class="sr-only">X</div>
            </a>
            <a href="https://www.instagram.com/kuropen" class="border rounded-lg p-2 shadow-lg">
                <img src="/images/instagram.png" class="mx-auto w-8 h-8 md:w-12 md:h-12" alt="Instagram" />
            </a>
            <a href="https://www.threads.net/kuropen" class="border rounded-lg p-2 shadow-lg">
                <div class="w-8 h-8 md:w-12 md:h-12 p-1 mx-auto">
            ...
            <a href="https://github.com/kuropen" class="border rounded-lg p-2 shadow-lg">
                <div class="w-8 h-8 md:w-12 md:h-12 p-1 mx-auto">
