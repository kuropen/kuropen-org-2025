...
@section('content')
    <section class="my-4 border border-indigo-700 rounded-xl p-4">
        ...
        <nav class="grid grid-cols-4 gap-4">
            ...
            <a href="https://x.com/kuropen_aizu" class="border border-gray-800 rounded-lg p-2">
            ...
            <a href="https://github.com/kuropen" class="border border-gray-800 rounded-lg p-2">
                <div class="w-8 h-8 md:w-12 md:h-12 p-1 mx-auto">
